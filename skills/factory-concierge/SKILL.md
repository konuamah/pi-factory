...
- Interview UI renders Markdown documents as terminal-friendly text. Markdown `---` rules do not create extra questions unless followed by a concrete `Q<n>` block, and echoed interview instructions are rejected rather than presented as questions.
