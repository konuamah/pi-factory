// Steward slide describe helpers — extracted from setup-tui.ts.

import type { FactorySetupContext, FactorySetupRecommendation } from "@factory/schemas";
import type { StewardSlide } from "./setup-tui.js";

export function describeWorkflowLines(rec: FactorySetupRecommendation, workflowSummary: ReturnType<typeof describeWorkflow>): string[] {
...
export function describeModelLines(ctx: FactorySetupContext, rec: FactorySetupRecommendation): string[] {
  return [
...
export function describeCommandLines(rec: FactorySetupRecommendation): string[] {
  return [
...
export function describeGitLines(ctx: FactorySetupContext, rec: FactorySetupRecommendation): string[] {
  return [
...
export function describeDependencyLines(ctx: FactorySetupContext, rec: FactorySetupRecommendation): string[] {
  return [
...
export function describeCapabilityLines(rec: FactorySetupRecommendation): string[] {
  return [
...
export function describeDashboardLines(ctx: FactorySetupContext, rec: FactorySetupRecommendation): string[] {
  return [
...
export function describeWorkflow(wf: NonNullable<FactorySetupRecommendation["workflow"]>["value"] | undefined): {
  label: string;
  idLine?: string;
  stageLine?: string;
} {
...
export function describeConfiguredModels(ctx: FactorySetupContext): string[] {
...
export function describeTaskRouting(ctx: FactorySetupContext, rec: FactorySetupRecommendation): string[] {
...
export function describeSkills(ctx: FactorySetupContext, rec: FactorySetupRecommendation): string[] {
...
export function isFactoryBuiltInSkill(id: string): boolean {
  return [
    "repo-interpretation",
...
export function describeConstitution(ctx: FactorySetupContext, rec: FactorySetupRecommendation): string[] {
